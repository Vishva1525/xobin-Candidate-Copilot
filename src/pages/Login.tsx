        ...
        >
          ...
          >
            ...
            >
              <button
                type="button"
                className="flex items-center justify-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.03] px-4 py-2.5 text-sm font-medium text-white/70 hover:bg-white/[0.06] hover:border-white/[0.12] transition-all"
              >
